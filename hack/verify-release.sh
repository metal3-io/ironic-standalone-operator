...
#
# Git setup:
# This script expects to be executed in the root directory of IrSO
...
# this repo
ORG="metal3-io"
PROJECT="${ORG}/ironic-standalone-operator"
REGISTRY="quay.io"
...
# NOTE(dtantsur): add "api/v${VERSION}" if we make api a go module
...
declare -a container_images=(
    "${ORG}/ironic-standalone-operator:v${VERSION}"
)
